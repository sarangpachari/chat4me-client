  ...
  const handleDeleteMember = async (memberId) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        toast.warning(
          "Unauthorized: Only the group creator can remove members"
        );
      }
    } catch (error) {
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="px-6 py-4">
                <p className="mb-4 text-sm md:text-lg flex items-center gap-2">
                  {" "}
                  <PlusSquareIcon /> Add new participants
                </p>
                <input
                  type="text"
              ...
              <div className="px-6 py-4 bg-emerald-100">
                <div className="grid gap-4">
                  ...
                  {details.groupMembers?.map((member) => (
                    <div
                      key={member._id}
                      className="flex items-center justify-between px-4 py-1 bg-emerald-700  rounded-lg hover:bg-emerald-400 transition-colors"
                    >
